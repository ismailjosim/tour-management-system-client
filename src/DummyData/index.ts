...
export const dummyCategories = ['Adventure', 'Beach', 'Cultural', 'Hiking', 'Relaxation'];
export const dummyTags = ['Travel', 'Explore', 'Nature', 'City Break'];
export const dummyFeaturedContent = 'https://via.placeholder.com/400x300.png?text=Featured+Content';
