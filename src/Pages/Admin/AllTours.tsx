...
import { useGetAllToursQuery, useRemoveTourMutation } from '@/redux/features/Tour/tour.api';
...
const AllTours = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      header: 'Location',
      className: 'font-medium',
      render: (location: string) => <div className="font-medium">{location}</div>,
    },
    {
      key: 'costFrom',
      header: 'Price',
      className: 'font-medium',
      render: (costFrom: number) => <div className="font-medium">${costFrom}</div>,
    },
    {
      key: 'duration',
      header: 'Duration',
    ...
    },
    {
      ...
      render: (maxGuest: number) => (
        <div className="hidden text-center sm:table-cell">{maxGuest} guests</div>
      ),
    },
    {
      key: 'actions',
