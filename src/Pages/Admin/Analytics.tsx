...
const Analytics: React.FC = () => {
  ...
  const avgPaymentAmount = paymentStats.avgPaymentAmount?.[0]?.avgPaymentAmount ?? 0;
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mb-8 flex items-center justify-center text-center">
        <div>
          <h1 className="mb-2 text-4xl font-bold">Tour Dashboard</h1>
          <p className="text-muted-foreground">Overview of your tour business performance</p>
        </div>
      </div>
