...
const DestinationDetails: React.FC = () => {
  ...
  const {
    ...
    isError: reviewError,
  } = useGetSpecificTourReviewsQuery({ tourId: destination?._id }, { skip: !destination });
      ...
      <div className="flex min-h-screen items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-500 dark:text-gray-400">
            The destination you're looking for could not be found. Please try again later.
          </p>
        </div>
      </div>
    );
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-8 lg:col-span-2">
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                <h2 className="mb-2 text-3xl font-bold capitalize md:text-5xl">{newTitle}</h2>
              ...
              <Link to={`/booking/${slug}`}>
                <Button className="w-full px-8 py-6 text-lg font-semibold md:w-auto">
                  Book Now
                </Button>
              </Link>
            </div>
                ...
                {newGallery.length > 0 && newGallery[0] !== DEFAULT_IMAGE ? (
                  <div className="grid gap-6 md:grid-cols-2">
                    {newGallery.map((image, idx) => (
                      <div key={idx} className="aspect-video overflow-hidden rounded-lg shadow-md">
                        <img
                          src={image}
            ...
            {/* Map Section */}
            <div className="space-y-5 rounded-md p-5 dark:bg-gray-800">
            ...
            <Card className="dark:bg-gray-800">
              ...
              <CardContent className="space-y-6">
                <Card className="bg-blue-600 text-center text-white dark:bg-blue-800">
          ...
          <div className="space-y-6 self-start lg:sticky lg:top-8">
            ...
            <Card className="dark:bg-gray-800">
              <CardContent className="pt-6">
                <div className="space-y-4 text-center">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold">Relson Dulux</h3>
                    <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                      Hello, We're content writers who are fascinated by content fashion, celebrity
                      and lifestyle. We help clients bring the right content to the right people.
                    </p>
                  </div>
                ...
                <ul className="space-y-2">
                  {dummyCategories.map((category, idx) => (
                    <li key={idx}>
                      <Button
                        variant="ghost"
                        className="w-full items-center justify-between hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-gray-700 dark:hover:text-blue-400"
                      >
                        <span>{category}</span>
            ...
            <Card className="overflow-hidden shadow-lg dark:bg-gray-800 dark:shadow-none">
              <CardHeader>
              ...
              <CardContent className="p-0">
                ...
                <div className="p-4">
                  ...
                  <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                    Explore the breathtaking beauty of the mountains with our limited-time offer.
            ...
            <Card className="dark:bg-gray-800">
              ...
              <CardContent>
                <div className="space-y-4 text-center text-gray-500 dark:text-gray-400">
                  <p>
                    This section will feature a list of other tours relevant to this destination.
                  </p>
                  <p>
                    You can fetch this data from your API and render it here in a carousel or grid
                    format.
                  </p>
                </div>
              </CardContent>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {tags.map((tag, idx) => (
                      <Badge
                        key={idx}
                        variant="outline"
                        className="cursor-pointer hover:border-blue-300 hover:bg-blue-50 dark:border-gray-700 dark:hover:border-blue-400 dark:hover:bg-gray-700"
                      >
                        {tag}
                      </Badge>
                    ))}
