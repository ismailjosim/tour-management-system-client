...
const Destinations = () => {
  ...
  const useDestinationData = (filters: Record<string, any>, currentPage: number, limit: number) => {
  ...
  const { isLoading, data, isError } = useDestinationData(filters, currentPage, limit);
  ...
  return (
    <>
      ...
      <section className="mx-auto my-20 w-11/12">
        <div className="grid gap-10 lg:grid-cols-5">
          ...
          <main className="col-span-4">
            ...
            <header className="mb-5 flex items-center justify-between gap-5">
              ...
              {hasResults && (
                <LayoutToggle isFlexLayout={isFlexLayout} onToggle={handleLayoutToggle} />
              )}
            </header>
