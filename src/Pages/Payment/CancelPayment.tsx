      ...
      <div className="w-full max-w-md rounded-[--radius] border border-[--color-border] bg-[--color-card] shadow-md transition-all duration-300 hover:shadow-lg">
        ...
        <div className="flex flex-col space-y-1.5 border-b border-[--color-border] p-6 text-center">
          ...
          <div className="mx-auto mb-2 h-16 w-16 text-[--color-destructive]">
            ...
            >
              <path
                fillRule="evenodd"
                d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zM12 8.25a.75.75 0 01.75.75v3.75a.75.75 0 01-1.5 0V9a.75.75 0 01.75-.75zM12 15a.75.75 0 100 1.5.75.75 0 000-1.5z"
                clipRule="evenodd"
              />
            </svg>
          </div>
        ...
        <div className="p-6">
          <div className="grid gap-4">
            ...
            {/* Amount row */}
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-[--color-muted-foreground]">Amount</span>
              <span className="text-sm font-semibold text-[--color-card-foreground]">
                {formattedAmount || 'N/A'}
              </span>
            </div>
            {/* Status row */}
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-[--color-muted-foreground]">Status</span>
              <span className="text-sm font-semibold text-[--color-destructive] capitalize">
                {params.status || 'N/A'}
              </span>
            </div>
          </div>
        ...
        <div className="border-t border-[--color-border] p-6 text-center">
          ...
          <button
            className="hover:bg-opacity-90 inline-flex h-10 items-center justify-center rounded-[--radius-sm] bg-[--color-primary] px-4 py-2 text-sm font-medium text-[--color-primary-foreground] ring-offset-[--color-background] transition-colors focus-visible:ring-2 focus-visible:ring-[--color-ring] focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50"
            onClick={() => {
