...
const Settings = () => {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      <h1 className="text-body mb-3 text-3xl font-bold">Settings</h1>

      <p className="text-primary-foreground max-w-md">
        This page is currently under development. We’re working on adding customization and
        preference options soon.
      </p>
