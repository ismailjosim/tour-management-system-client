...
const Support = () => {
	return (
		<div className='flex min-h-[60vh] flex-col items-center justify-center px-4 text-center'>
			<h1 className='mb-3 text-3xl font-bold text-body'>Support</h1>

			<p className='max-w-md text-primary-foreground'>
				The Support page is currently under development. We’re working on help
				resources, FAQs, and contact options.
			</p>
