...
const Verify = () => {
  ...
  const state = location.state as string | { email?: string; from?: Location } | null;
    ...
    <section className="grid h-screen place-content-center">
      {confirm ? (
        <div className="flex flex-col items-center justify-center">
          <div className="w-full max-w-md rounded-2xl border border-gray-700 bg-gray-800 p-8 shadow-xl">
            {/* Header */}
            <h2 className="mb-2 text-center text-3xl font-bold text-white">OTP Verification</h2>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                />
                <Button
                  className="w-full cursor-pointer rounded-xl bg-teal-600 px-4 py-3 font-bold text-white shadow-lg transition-colors duration-200 hover:bg-teal-700"
                  type="submit"
                >
                  Verify Account
                </Button>
              ...
              <button
                ...
                className={cn(
                  ...
                  timer === 0
                    ...
                    : 'cursor-not-allowed text-teal-500/40'
                )}
              >
                Resend OTP
              </button>
              {timer !== 0 && <span className="ml-2 text-gray-400">{timer}s</span>}
            </div>
            ...
            <div className="mt-4 text-center">
              <Link
                ...
                className="text-gray-400 transition-colors duration-200 hover:text-teal-500"
              >
                &larr; Back to Login
              </Link>
            </div>
