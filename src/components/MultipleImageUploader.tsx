        ...
        {previews.length > 0 ? (
          <div className="flex w-full flex-col gap-3">
            <div className="flex items-center justify-between gap-2">
              <h3 className="truncate text-sm font-medium">Uploaded Images ({previews.length})</h3>
              <Button
                variant="outline"
                size="sm"
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
              {previews.map((img, idx) => (
                <div
                  key={idx}
                  className="bg-accent relative aspect-square overflow-hidden rounded-md"
                >
                  <img
          ...
          <div className="flex flex-col items-center justify-center px-4 py-3 text-center">
            ...
            <p className="text-muted-foreground text-xs">JPG, PNG, GIF (max. {maxSizeMB}MB each)</p>
