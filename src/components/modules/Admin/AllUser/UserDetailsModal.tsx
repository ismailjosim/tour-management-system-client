...
import { Phone, MapPin, Mail, Calendar, Shield, CheckCircle, XCircle } from 'lucide-react';
      ...
      <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xl font-semibold">{user.name ?? 'Unknown User'}</div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Badge variant={getStatusBadgeVariant(user.isActive)} className="capitalize">
              ...
              {user.address && (
                <div className="flex items-center gap-3 md:col-span-2">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground text-sm">{user.address}</div>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
              ...
              {user.createdAt && (
                <div className="bg-muted/50 rounded-lg p-4 text-center">
                  ...
                  <div className="text-muted-foreground text-sm">Joined Date</div>
                </div>
              )}
            </div>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="bg-muted/50 flex items-center justify-between rounded-lg p-3">
                    ...
                    <Badge variant="outline">{formatAuthProviders(user.auths)}</Badge>
                  </div>
                  {user.auths.map((auth, index) => (
                    <div key={index} className="flex items-center justify-between p-2 pl-8 text-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{user.isDeleted ? 'Yes' : 'No'}</span>
              </div>
              <div className="flex justify-between">
