    ...
    },
    {
      ...
      render: (name: string, item: IUser) => (
        <div className="font-medium">
          ...
          <div className="text-muted-foreground max-w-[150px] truncate text-sm" title={item.email}>
            {item.email}
          </div>
        </div>
      ),
    ...
    },
    {
      ...
      render: (phone: string | undefined, item: IUser) => (
        <div className="text-sm">
          ...
          {item.address && (
            <div className="text-muted-foreground max-w-[120px] truncate" title={item.address}>
              {item.address}
            </div>
          )}
        </div>
