...
import { useAddTourTypeMutation, useUpdateTourTypeMutation } from '@/redux/features/Tour/tour.api';
...
const AddTourModal = ({ tourTypeId, initialName = '', triggerButton }: AddTourModalProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>{isEditMode ? 'Edit Tour Type' : 'Add New Tour Type'}</DialogTitle>
          <DialogDescription>
