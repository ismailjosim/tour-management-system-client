...
const applyGuideSchema = z.object({
  ...
  nidPhoto: z.any().refine((file) => file instanceof File, 'NID photo is required'),
});
      ...
      <DialogContent className="sm:max-w-[450px]">
        ...
        <Form {...form}>
          <form className="space-y-5" onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <FormField
              ...
              render={() => (
                <FormItem>
                  ...
                  <FormControl>
                    <SingleImageUploader
                      initialImage={nidPhoto ? URL.createObjectURL(nidPhoto) : null}
                      onChange={(file) => {
                        setNidPhoto(file);
            ...
            {/* --- Submit Button --- */}
            <Button className="w-full" type="submit" disabled={!nidPhoto || submitting}>
