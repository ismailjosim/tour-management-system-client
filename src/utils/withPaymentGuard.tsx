  ...
  return function PaymentGuardWrapper() {
    ...
    useEffect(() => {
      const validatePaymentAccess = () => {
        ...
        const hasValidSession = paymentState && paymentState.timestamp > Date.now() - 600000; // 10 min expiry
      ...
      return (
        <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-950">
          <div className="space-y-4 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">Validating payment...</p>
          </div>
        </div>
      );
    }
